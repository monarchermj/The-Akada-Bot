...
client.on('message', message => {
    ...
    if(command === 'hello'){
        ...
        message.channel.send('For bot commands, type **-coms** in **<#822337015688855562>**.\n\nCheck Out The <#821732987779022880> tab!');
    }
        ...
        message.channel.send('Check out the <#822116540647473172> tab!');
    }
